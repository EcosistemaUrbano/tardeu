...
<div class="post clearfix">
    ...
    <div class="post-meta">
    	...
    	<div class="post-meta-top-hidden">
	...
	?>
		<div class="post-thumbnail">
			...
			<div><?php the_post_thumbnail('post-full'); ?></div>
			<!-- <a href="<?php echo $full_img[0]; ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail('post-full'); ?></a> -->
		</div>
		<!-- END post-thumbnail -->
	<?php } ?>
